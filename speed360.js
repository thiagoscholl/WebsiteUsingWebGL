...
async function main() {
  ...
  const canvas = document.getElementById("canvasSpeed360");
  ...
  const objOffset = m4.scaleVector(
    m4.addVectors(
      ...
      zoom.addEventListener("input", () => {
        const val = parseInt(zoom.value) * -0.265 + 8;
      ...
      var botaoblack = document.getElementById("blacktex");
      botaoblack.addEventListener("click", function() {
        loadTexture(1);
      });

      var botaored = document.getElementById("redtex");
      ...
      async function loadTexture(index) {
        ...
        //if (blackbtn) {
          ...
          const matTexts = await Promise.all(
            ...
            const response = await fetch("./obj/speedrecaro/source/Recaro" + index + ".mtl");
